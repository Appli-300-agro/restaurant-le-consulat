# Restaurant Le Consulat - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Restaurant Le Consulat**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@restaurantleconsulat.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@restaurantleconsulat.cm` | `user123` | |
...
*   **Contact :** contact@restaurantleconsulat.cm